...
description: Use inside superspec after a meaningful implementation milestone to request focused review against tasks, requirements, and recent diffs.
---

# Superpowers Requesting Code Review For SuperSpec
