...
description: 在 devflow 的 Align 阶段使用，强制先讨论再 plan。只要还没有明确方向、用户说“先梳理”“先讨论”“先写 plan”或任务即将进入 plan/spec/apply，都应该先用它；没有对齐确认，不得继续。
---
...
6. **Write design doc** — save to `.devflow/<mission-slug>/plans/YYYY-MM-DD-<topic>-align.md` and commit
...
- Write the validated design (spec) to `.devflow/<mission-slug>/plans/YYYY-MM-DD-<topic>-align.md`
  - (User preferences for spec location override this default)
- Use elements-of-style:writing-clearly-and-concisely skill if available
- Keep the alignment/design note in the current devflow mission workspace
...
> "Alignment note written to `<path>`. Please review it and let me know if you want to make any changes before we start writing out the implementation plan."
